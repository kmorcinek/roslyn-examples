...
public class QueryableAnyDetectorTests
{
    [Fact]
    public void Detects_Any_OnIQueryableParameter()
    {
        ...
        Assert.Equal(1, QueryableAnyDetector.DetectSource(source));
    }
    ...
    public void Does_Not_Detect_Any_OnList()
    {
        ...
        Assert.Equal(0, QueryableAnyDetector.DetectSource(source));
    }
    ...
    public void Detects_Multiple_Occurrences()
    {
        ...
        Assert.Equal(2, QueryableAnyDetector.DetectSource(source));
    }
}
